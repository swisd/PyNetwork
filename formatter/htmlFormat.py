...
def scan_dir(dir: str) -> None:
    ...
    for filename in os.listdir(dir):
        ...
        if os.path.isfile(_f):
            if not ((dir.startswith("C:/Network/.git") or dir.startswith("C:/Network/.venv")) or ((".gitignore" in filename) or (".idea" in dir) or ("enc.comp" in dir) or ("/f/" in dir)) or ('/db') in dir):
                print("FILE:", _f)
